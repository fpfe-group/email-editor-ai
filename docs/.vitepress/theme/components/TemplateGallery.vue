...
const categoryLabelMap = Object.fromEntries(categories.map(cat => [cat.key, cat.label]))
...
<template>
  <section class="tpl-gallery">
    <div class="tpl-gallery__header">
      <p class="tpl-gallery__eyebrow">入门模板</p>
      <h2 class="tpl-gallery__title">
        从专业模板开始
      </h2>
      <p class="tpl-gallery__subtitle">
        {{ templates.length }} 个专业模板可直接定制。选择一个模板，在编辑器中打开并调整为你的版本。
      </p>
    </div>
        ...
        <div v-if="previewTemplate" class="tpl-modal" @click.self="closePreview">
          <div class="tpl-modal__panel">
            ...
            <div class="tpl-modal__sidebar">
              <button class="tpl-modal__close" @click="closePreview" aria-label="关闭">
              ...
              <div class="tpl-modal__info">
                ...
                <span class="tpl-modal__cat">{{ categoryLabel(previewTemplate.category) }}</span>
              </div>
              <div class="tpl-modal__nav">
                <button class="tpl-modal__nav-btn" :disabled="!canPrev" @click="navigatePreview(-1)" aria-label="上一个">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
                </button>
                <button class="tpl-modal__nav-btn" :disabled="!canNext" @click="navigatePreview(1)" aria-label="下一个">
