...
const showcaseTemplates = [
  { id: "black-friday-deal", label: "黑五促销" },
  { id: "fashion-gift-guide", label: "时尚礼品指南" },
  { id: "product-launch-aurora", label: "新品发布" },
  { id: "holiday-sale-christmas", label: "节日促销" },
  { id: "travel-newsletter", label: "旅行 Newsletter" },
];
...
<template>
  <section class="hero" :class="{ 'hero--visible': loaded }">
    ...
    <div class="hero__inner">
      <div class="hero__content">
        <div class="hero__badge">
          ...
          开源 &middot; MIT License
        </div>
        <h1 class="hero__title">
          用拖拽和 AI<br />
          <span class="hero__title-gradient">快速设计专业邮件</span>
        </h1>
        <p class="hero__desc">
          描述你想要的邮件，让 AI 生成初稿；也可以直接拖拽区块自行搭建。
          这是一个面向 Vue 3 的邮件编辑器，内置 AI Chat、47 个免费模板、 MJML
          渲染和完整响应式预览。
        </p>
        <div class="hero__actions">
          <a
            href="https://www.npmjs.com/package/@fpfe-group/email-editor-ai"
          ...
          >
            ...
            npm i @fpfe-group/email-editor-ai
          </a>
          <a
            href="https://github.com/fpfe-group/email-editor-ai.git"
    ...
    <div class="hero__editor">
      <div
        class="editor-showcase"
        :class="{ 'editor-showcase--visible': loaded }"
      >
        <!-- Window chrome -->
        <div class="editor-showcase__chrome">
          ...
          <span class="editor-showcase__chrome-title"
            >{{ currentTemplate.label }} — email-editor-ai</span
          >
        </div>
        <!-- Editor layout -->
        <div class="editor-showcase__body">
          ...
          <div class="editor-showcase__canvas">
            <div class="editor-showcase__viewport">
              <div
                class="editor-showcase__vp-btn editor-showcase__vp-btn--active"
              >
                <svg
                  width="13"
                  height="13"
            ...
            <div class="editor-showcase__nav">
              <button
                ...
                :class="{
                  'editor-showcase__nav-dot--active': idx === activeIndex,
                }"
                :aria-label="'查看 ' + tpl.label"
                @click="goTo(idx)"
              />
            </div>
          </div>
          ...
          <div class="editor-showcase__sidebar">
            <div class="editor-showcase__tabs">
              <span class="editor-showcase__tab editor-showcase__tab--active"
                >区块</span
              >
              <span class="editor-showcase__tab">样式</span>
              <span class="editor-showcase__tab">图层</span>
              <span class="editor-showcase__tab editor-showcase__tab--ai"
                >AI</span
              >
            </div>
            <div class="editor-showcase__sidebar-body">
              <div class="editor-showcase__search">
                ...
                <span class="editor-showcase__search-text">搜索区块...</span>
              </div>
              <span class="editor-showcase__section-label">结构</span>
              <div class="editor-showcase__block-grid">
                <div class="editor-showcase__block-item">
                  <div
                    class="editor-showcase__block-icon editor-showcase__block-icon--teal"
                  />
                  <span>1 列</span>
                </div>
                <div class="editor-showcase__block-item">
              ...
              <span class="editor-showcase__section-label">内容</span>
              <div class="editor-showcase__block-grid">
                <div class="editor-showcase__block-item">
                  <div
                    class="editor-showcase__block-icon editor-showcase__block-icon--purple"
                  />
                  <span>标题</span>
                </div>
                <div class="editor-showcase__block-item">
                ...
                <div class="editor-showcase__block-item">
                  <div
                    class="editor-showcase__block-icon editor-showcase__block-icon--amber"
                  />
                  <span>图片</span>
                </div>
                <div class="editor-showcase__block-item">
              ...
              <span class="editor-showcase__section-label">现成区块</span>
...
.hero__glow {
  ...
  background: radial-gradient(
    ellipse at center,
    rgba(1, 168, 171, 0.15) 0%,
    rgba(1, 168, 171, 0.05) 40%,
    transparent 70%
  );
  pointer-events: none;
}
...
.editor-showcase {
  ...
  box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.05),
    0 32px 80px rgba(0, 0, 0, 0.5), 0 0 120px rgba(1, 168, 171, 0.08);
  opacity: 0;
...
.editor-showcase__dot--red {
  background: #ff5f56;
}
.editor-showcase__dot--yellow {
  background: #ffbd2e;
}
.editor-showcase__dot--green {
  background: #27c93f;
}
...
.editor-showcase__block-icon--teal {
  background: linear-gradient(135deg, #01a8ab, #059669);
}
.editor-showcase__block-icon--purple {
  background: linear-gradient(135deg, #6366f1, #818cf8);
}
.editor-showcase__block-icon--amber {
