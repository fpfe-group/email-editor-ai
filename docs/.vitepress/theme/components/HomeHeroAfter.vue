...
const stats = [
  { number: "36", label: "入门模板" },
  { number: "43", label: "拖拽区块" },
  { number: "147+", label: "测试" },
  { number: "MIT", label: "许可证" },
];
  ...
  <div class="home-after">
    ...
    <div :ref="setSectionRef" class="reveal-section">
      <section class="home-code">
        <h2 class="home-code__title">几秒即可使用</h2>
        <p class="home-code__subtitle">安装、导入、使用，就这么简单。</p>
...
<span class="code-keyword">import</span> { <span class="code-tag">EmailEditor</span> } <span class="code-keyword">from</span> <span class="code-string">'@fpfe-group/email-editor-ai'</span>
<span class="code-keyword">import</span> <span class="code-string">'@fpfe-group/email-editor-ai/style.css'</span>
